...
describe('ResultDisplayComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [{ provide: Router, useValue: router }, { provide: SelectionService, useValue: SelectionServiceStub }],
  ...
  it('should call api', () => {
    fixture.detectChanges();
    let actual: any;
    component.call_API(testUrl, testData).subscribe(value => (actual = value));
  ...
  it('should scan upper range', waitForAsync(() => {
    ...
    fixture.whenStable().then(() => {
      expect(component.chartOptions.plugins!.title!.text).toBe("Scan over upper value of time range")
  ...
  it('should scan lower range', waitForAsync(() => {
    ...
    fixture.whenStable().then(() => {
      expect(component.chartOptions.plugins!.title!.text).toBe("Scan over lower value of time range")
      expect(component.hideLoading).toHaveBeenCalledOnceWith()
      expect(component["updateChart"]).toHaveBeenCalledOnceWith()
      expect(component.ResponseStatusCode).toBe(200)
      expect(component.plotData.length).toBe(expectedLength)
