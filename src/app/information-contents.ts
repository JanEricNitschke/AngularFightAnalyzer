export const informationmap = new Map<string, string>([
  ...
  [
    "CT",
    "Select whether you want to filter directly by weapons or generally by classes for CT's.<br>The players must have had at least one matching weapon in their inventory.<br> If nothing is specified then no filter is applied on the CT's inventories.",
  ],
  [
    "T",
  ...
  [
    "Time",
    "Select the time range you want to consider.<br> The value for a kill is how much time has passed between the end of freeze time and the kill, NOT the game time when the kill occurred.<br>\
