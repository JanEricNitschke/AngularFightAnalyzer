...
describe("FightSelectorComponent", () => {
  ...
  it("should getcookie", () => {
    let cookiespy = spyOn<any>(CookieServiceStub, "check").and.callFake(
      function () {
        return true;
      },
    );
    spyOn(JSON, "parse");
    let requestspy = spyOn(component, "isRequestData").and.callFake(function (
      obj: any,
    ): obj is RequestData {
      return true;
    });
  ...
  it("should deletecookie", () => {
    ...
    expect(CookieServiceStub.delete).toHaveBeenCalledWith(
      ConsentServiceStub.cookie_name,
    );
  });
  ...
  it("setSettings should call children", () => {
    ...
    const WeaponChild1: WeaponSelectorComponent =
      component.WeaponsChildren.get(0)!;
    const WeaponChild2: WeaponSelectorComponent =
      component.WeaponsChildren.get(1)!;
    const WeaponChild3: WeaponSelectorComponent =
      component.WeaponsChildren.get(2)!;
  ...
  it("test events from children", () => {
    ...
    component.TimeComponent.endingEvent.emit("51");
