...
describe('TimeSelectorComponent', () => {
  ...
  it('should adjust_end_min', () => {
    ...
    expect(component.lowerBoundMax).toBe((parseInt(component.valueMin) + 1).toString())
  ...
  it('should adjust_start_max', () => {
    ...
    expect(component.upperBoundMin).toBe((parseInt(component.valueMax) - 1).toString())
  ...
  it('should reset', () => {
    ...
    expect(component.endEvent.emit).toHaveBeenCalledWith("175")
  });
  ...
  it('should set settings', () => {
    ...
    expect(component.endEvent.emit).toHaveBeenCalledWith("162")
  });
